...
const setNewsDataTable = (payload: PaginationModel) => async (dispatch: Dispatch<NewsReducerTypes>) => {
  try {
    dispatch({
...
const setSingleNews = (news_pk: number) => async (dispatch: Dispatch<NewsReducerTypes>) => {
  try {
    dispatch({
...
const addNews = (payload: FormData, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
  try {
    dispatch({
...
const addNewsFiles =
  (payload: FormData, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
    try {
      dispatch({
        type: "SET_PAGE_LOADING",
        page_loading: {
...
const updateNews = (payload: NewsModel, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
  try {
    dispatch({
      type: "SET_PAGE_LOADING",
      page_loading: {
...
const republishNews = (news_pk: number, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
  try {
    dispatch({
      type: "SET_PAGE_LOADING",
      page_loading: {
...
const unpublishNews = (news_pk: number, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
  try {
    dispatch({
      type: "SET_PAGE_LOADING",
      page_loading: {
...
const addNewsComment =
  (payload: NewsCommentModel, successCallback: (msg: string) => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
    try {
      dispatch({
        type: "SET_PAGE_LOADING",
        page_loading: {
...
const toggleLike = (payload: NewsLikesModel, successCallback: () => any) => async (dispatch: Dispatch<NewsReducerTypes | PageReducerTypes>) => {
  try {
