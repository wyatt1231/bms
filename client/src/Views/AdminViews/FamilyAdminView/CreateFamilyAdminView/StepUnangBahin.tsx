import { Button, Divider, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from "@material-ui/core";
...
export const StepUnangBahin: FC<IStepUnangBahin> = memo(({ handleSetUloPamExtProps, defaultUloPamilya, default_purok, ulo_pamilya_extend_props }) => {
  ...
  return (
    <div style={{ margin: `0 3em` }}>
      <Grid container spacing={2}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <AutocompleteHookForm
                  ...
                  name="ulo_pamilya"
                  fullWidth
                  defaultInputValue={!!defaultUloPamilya ? defaultUloPamilya : ""}
                  InputLabelProps={{
                    shrink: true,
                  }}
                  variant="outlined"
              ...
              <Grid item xs={2}>
                <TextField
                  ...
                  variant="outlined"
                  disabled
                  value={!!ulo_pamilya_extend_props?.purok ? ulo_pamilya_extend_props.purok : !!default_purok ? default_purok : ""}
                  label="Purok"
                  InputLabelProps={{
                    shrink: true,
                  }}
              ...
              <Grid item xs={3}>
                <TextField
                  ...
                  variant="outlined"
                  disabled
                  value={InvalidDateToDefault(ulo_pamilya_extend_props?.resident_date, "-")}
                  label="Resident Date"
                  InputLabelProps={{
                    shrink: true,
                  }}
        ...
        <Grid item xs={12}>
          <div className="title">MEMBERS IN THE FAMILY</div>
        </Grid>
