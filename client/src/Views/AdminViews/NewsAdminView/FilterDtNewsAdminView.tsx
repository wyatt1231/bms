...
export const FilterDtNewsAdminView: FC<IFilterDtNewsAdminView> = memo(
              ...
              <Grid container justify="center" spacing={2}>
                <Grid item xs={12}>
                  ...
                  <TextFieldHookForm
                    ...
                    variant="outlined"
                    fullWidth={true}
                    placeholder="Ibutang ang mga letra sa titulo nga gusto pangitaon"
                    InputLabelProps={{
                      shrink: true,
                    }}
                  />
