...
export const FilterDtPostAdinView: FC<IFilterDtPostAdinView> = memo(
  ({ handleSetTableFilter, table_filter, handleRefetchTable }) => {
    ...
    return (
      <>
        <StyledFilter>
          <div className="title">I-sala ang resulta</div>
          <FormProvider {...form_add_news}>
            ...
            >
              <Grid container justify="center" spacing={2}>
                ...
                <Grid item xs={12}>
                  <div className="filter-main-title">Pagsala sa resulta</div>
