...
export const EditResident: FC<IEditResident> = memo(
  ({ resident_pk, open, handleClose }) => {
    ...
    useEffect(() => {
      if (selected_resident?.pic) {
        var file = dataURLtoFile(
          `data:image/jpg;base64,${selected_resident.pic}`,
          "adasdas.jpg"
        );
        setPic(file);
      }
    ...
    return (
      <>
        <FormDialog
          title="Ilisi ang impormasyon na gusto usabon."
