...
export const ManageResidentAdminView: FC<IManageResidentAdminView> = memo(
  () => {
    ...
    const selected_resident = useSelector(
      (store: RootStore) => store.ResidentReducer.selected_resident
    );
    const fetching_selected_resident = useSelector(
      (store: RootStore) => store.ResidentReducer.fetching_selected_resident
    );

    const family_of_resident = useSelector(
      (store: RootStore) => store.FamilyReducer.family_of_resident
    );
    ...
    const handleToggleActive = useCallback(() => {
      dispatch(
        setGeneralPrompt({
          ...
          continue_callback: () =>
            dispatch(
              ResidentActions.toggleResidentStatus(
                resident_pk,
                (msg: string) => {
    ...
    const fetch_family_of_resident = useSelector(
      (store: RootStore) => store.FamilyReducer.fetch_family_of_resident
    );
        ...
        <Grid container spacing={4}>
                    ...
                    >
                      ...
                      <Grid item>
                        <CustomAvatar
                          height={20}
                          width={20}
                          src={selected_resident?.pic}
                          errorMessage={selected_resident?.first_name?.charAt(
                            0
                          )}
                        />
                      </Grid>
                      ...
                      <Grid item>
                        <Chip
                          ...
                          style={{
                            backgroundColor:
                              selected_resident?.status?.sts_backgroundColor,
                      ...
                      <Grid container>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <div className="info-group row">
                            ...
                            <div className="value">
                              {StringEmptyToDefault(
                                selected_resident.civil_status,
                                "-"
                              )}
                            </div>
                          </div>
                        ...
                        <Grid item xs={12}>
                          <div className="info-group row">
                            <div className="label">
                              Matang sa trabaho, kanunay o panagsa?
                            </div>
                            <div className="value">
                              {StringEmptyToDefault(
                                selected_resident.employment,
                                "-"
                              )}
                            </div>
                          </div>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <div className="info-group row">
                            ...
                            <div className="value">
                              {selected_resident.with_disability === "y"
                                ? "Oo"
                                : "Dili"}
                            </div>
                          </div>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <div className="info-group row">
                            <div className="label">
                              Adlaw sugod pagpuyo sa barangay
                            </div>
                            <div className="value">
                              {InvalidDateToDefault(
                                selected_resident.resident_date,
                                "-"
                              )}
                            </div>
                          </div>
                        ...
                        <Grid item xs={12} sm={6}>
                          <div className="info-group row">
                            <div className="label">
                              Adlaw pagkamatay (kung patay na)
                            </div>
                            <div className="value">
                              {InvalidDateToDefault(
                                selected_resident.died_date,
                                "-"
                              )}
                            </div>
                          </div>
          ...
          {family_of_resident && !fetch_family_of_resident && (
            <Grid item xs={12} md={12}>
              ...
              >
                <div className="title">
                  Tibuok impormasyon sa pamilya sa residente
                </div>
                ...
                <Grid container>
                  <Grid item xs={6}>
                      ...
                      <div className="info-group">
                        ...
                        <div className="value profile">
                          <CustomAvatar
                            ...
                            errorMessage={family_of_resident?.ulo_pamilya_info?.first_name.charAt(
                              0
                            )}
                          />
                          {family_of_resident?.ulo_pamilya_info?.first_name}{" "}
                          {family_of_resident?.ulo_pamilya_info?.middle_name}
                          {family_of_resident?.ulo_pamilya_info?.last_name}{" "}
                          {family_of_resident?.ulo_pamilya_info?.suffix}
                        </div>
                      </div>
                    </Grid>
                    <Grid item>
                      <div className="info-group">
                        ...
                        <div className="value">
                          {family_of_resident?.okasyon_balay}
                        </div>
                      </div>
                    </Grid>
                    <Grid item>
                    ...
                    <Grid item>
                      <div className="info-group">
                        <div className="label">
                          Kadugayon sa pagpuyo sa Barangay (tuig)
                        </div>
                        <div className="value">
                          {family_of_resident?.kadugayon_pagpuyo}
                        </div>
                      </div>
                    </Grid>
                    <Grid item>
                      <div className="info-group">
                        ...
                        <div className="value">
                          {family_of_resident?.okasyon_yuta}
                        </div>
                      </div>
                    </Grid>{" "}
                    <Grid item>
                      <div className="info-group">
                        ...
                        <div className="value">
                          {family_of_resident?.kaligon_balay}
                        </div>
                      </div>
                    </Grid>
                  </Grid>
                              ...
                              <TableCell>
                                <div className="table-cell-profile">
                                  <CustomAvatar
                                    ...
                                    errorMessage={f?.resident_info?.first_name.charAt(
                                      0
                                    )}
                                  />
                                  <div className="title">
