...
const ResidentController = async (app: Express): Promise<void> => {
  ...
  router.post("/getDataTableResident", Authorize("admin,resident"), async (req: Request, res: Response) => {
    try {
  ...
  router.post("/addResident", Authorize("admin,resident"), async (req: Request & UserClaims, res: Response) => {
    try {
  ...
  router.post("/updateResident", Authorize("admin"), async (req: Request & UserClaims, res: Response) => {
    try {
      const payload: AdministratorModel = req.body;
  ...
  router.post("/toggleResidentStatus", Authorize("admin"), async (req: Request & UserClaims, res: Response) => {
    try {
  ...
  router.post("/toggleResidentLogin", Authorize("admin"), async (req: Request & UserClaims, res: Response) => {
    try {
      const resident_pk: number = req.body.resident_pk;
      res.json(await ResidentRepository.toggleResidentLogin(resident_pk));
    } catch (error) {
      res.json(500);
    }
  });

  router.post("/getSingleResident", Authorize("admin"), async (req: Request & UserClaims, res: Response) => {
    try {
  ...
  router.post("/searchResident", Authorize("admin,resident"), async (req: Request & UserClaims, res: Response) => {
    try {
